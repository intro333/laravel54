...
var Loader = function (_Component) {
  ...
  _createClass(Loader, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', null, _react2.default.createElement('div', { className: 'modal-backdrop-white fade in', style: onOff ? modalStyleOn : modalStyleOff }), _react2.default.createElement('div', { className: modalFadeIn, role: 'dialog', style: onOff ? modalStyleOn : modalStyleOff }, _react2.default.createElement('div', { className: 'modal-dialog-loader modal-sm' }, _react2.default.createElement('div', { className: 'modal-content-loader' }, _react2.default.createElement('div', { className: 'modal-animation' }, _react2.default.createElement('div', { className: 'modal-loader-animation__item' }, _react2.default.createElement('img', { src: '/images/loader.gif' })))))));
    }
  }]);
